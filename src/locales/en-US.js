export default {
  ...
  'menu.home': 'Home',
  'menu.enterpriseManagement': 'Enterprise Management',
  'menu.enterpriseLanguageManagement': 'Enterprise Language Management',
  'menu.product': 'Product',
  'menu.productLanguage': 'product Language',
  'menu.categoryManagement': 'Category Management',
  'menu.categoryLanguageManagement': 'Category Language Management',
  'menu.email': 'Email Management',
  'menu.emailTemplate': 'Email Template Management',
  'menu.askManagement': 'Ask Management',
  'menu.dataAnalysis': 'Data Analysis',
  'menu.dataAnalysis.commodityGrowth': 'Commodity Growth',
  'menu.dataAnalysis.askAboutGrowth': 'Ask About Growth',
  'menu.dataAnalysis.userGrowth': 'User Growth',
  'menu.administratorSettings': 'Administrator Settings',
