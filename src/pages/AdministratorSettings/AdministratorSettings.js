...
import { renderTitle, renderStatus, renderFunctions, renderBatchFunctions, formatTokensData, handleRes, formatFieldValue } from '@/utils/commonFunction'
...
class AdministratorSettings extends Component {
  ...
  onConfirm = props => {
    ...
    const managerTokens = formatTokensData(record);
    confirm({
  ...
  render() {
    const { tabActiveKey, selectedRows, modalState, initialFormData, countSelect } = this.state;
    ...
    const conditionConfig = [{ fieldId: 'account', label: '管理员', fieldType: 'input' }];
    return (
      <PageHeaderWrapper title="管理员管理">
        <Card bordered={false}>
          <div className={styles.tableList}>
            ...
            <Tabs defaultActiveKey="all" onChange={this.onTabChange}>
