...
import { renderStatus, renderFunctions, formatTime, renderCensorTag, renderBatchFunctions, formatTokensData, handleRes } from '@/utils/commonFunction'
import { MockSelect } from '@/utils/Enum';

import styles from './AskManagement.less';

const { countrySelect } = MockSelect;
const { TabPane } = Tabs;
const { confirm } = Modal;
